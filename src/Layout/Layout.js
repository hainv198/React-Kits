            ...
            <Row >
                <Col sm={12}>
                    ...
                    <Navbar collapseOnSelect
                            ...
                            bg="dark"
                            variant="dark"
                            style={{width:'100%',position:'fixed', overflow:'hidden', zIndex:1040, top:0, justifyContent:'space-evenly'}}
                    >
                        <Nav >
                        ...
                        <div style={{display:'flex'}}>
                            <Nav.Link as={NavLink} to="/about" exact style={{display:'flex'}}>
                            ...
                            <Nav.Link as={NavLink} to="/admin" exact style={{padding:'unset'}}>
                                <BadgeAvatars/>
                            </Nav.Link>
                        </div>
                    </Navbar>
