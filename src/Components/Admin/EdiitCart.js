        ...
        <div className='container' style={{marginTop:100}}>
            {cart != null ? (
                <div className="container">
                    <div className="container">
                        <div className="container">
                            <div className="col-lg-10 col-md-12 mx-auto col-sm-12" style={{display:'flex', justifyContent:'space-between'}}>

                                <div>
                                    <div style={{width:300, height:300, borderRadius:'50%', backgroundColor:'#b75d5d'}}></div>
                                </div>
